...
_See code: [src/commands/acc-transformer/transform.ts](https://github.com/mcarvin8/apex-code-coverage-transformer/blob/v3.1.6/src/commands/acc-transformer/transform.ts)_
<!-- commandsstop -->
