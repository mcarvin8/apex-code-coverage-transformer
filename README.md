...
- **"Fixes" inaccuracies** in Salesforce CLI deploy command coverage reports, such as:
  ...
  - To address these inaccuracies, the plugin includes a **re-numbering function** that only applies to deploy coverage reports. This function reassigns out-of-range covered lines to unused lines, ensuring correct coverage for uncovered lines as reported by the Salesforce CLI.
