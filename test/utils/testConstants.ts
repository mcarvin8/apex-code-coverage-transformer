...
export const deployCoverage2 = resolve(fixturesDir, 'inputs/deploy_coverage_2.json');
export const testCoverage = resolve(fixturesDir, 'inputs/test_coverage.json');
export const testCoverage2 = resolve(fixturesDir, 'inputs/test_coverage_2.json');
