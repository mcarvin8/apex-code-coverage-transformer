...
* **deps:** bump @salesforce/core in the dependencies group ([#395](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/395)) ([bfc7dd7](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/bfc7dd7fed0abc7debda172558cd259f51e867fe))
...
* **ci:** fix release tag order + catch up stale README ([#378](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/378)) ([a48b4e1](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/a48b4e1462e7343d3b5a50dfda0cc4ab8ddac9a1))
...
* **deps:** replace fast-xml-builder with in-house XML builder ([#373](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/373)) ([b537784](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/b537784cc1568a8c32bd8a4e06c954ee86e2f63f))
...
* **deps:** bump the salesforce group with 4 updates ([#361](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/361)) ([20ec3b9](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/20ec3b95d508255dca410324da13c65bd0cf0e1b))
...
* **deps:** bump fast-uri from 3.1.4 to 3.1.5 ([#358](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/358)) ([548bb26](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/548bb2600f4d9b82c5e6a1659a050411e4a44e4c))
* **deps:** bump undici from 8.5.0 to 8.10.0 ([#356](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/356)) ([cab5329](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/cab53299876e2f811061dfd3dbf4b486c3357bf9))
...
* **prereq:** fix readme node requirement ([b226970](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/b22697009d80e41b96d4d7dd5f4caf7aef63c014))

## [2.23.1](https://github.com/mcarvin8/apex-code-coverage-transformer/compare/v2.23.0...v2.23.1) (2026-06-29)


### Bug Fixes

* **deps:** update all deps, drop Node 20 support ([#323](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/323)) ([a172ba5](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/a172ba53c3dd7dc4521cbf13f70392c0b6f29bd3))

## [2.23.0](https://github.com/mcarvin8/apex-code-coverage-transformer/compare/v2.22.1...v2.23.0) (2026-06-17)


### Features

* support multiple coverage JSON inputs with union merge ([#317](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/317)) ([43ccda6](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/43ccda6c2542cbb0be36faba37682a23b76758b8))
...
* log out-of-range covered line remappings at debug level ([#300](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/300)) ([e812869](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/e812869eff4290af8d3e519ea59fd754475ac325))
...
* **deps:** pin direct dependencies to exact versions ([#286](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/286)) ([2624efc](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/2624efcb0c85a1856238613037ea9462e2c65287))
...
* **perf:** switch from fast-xml-parser to fast-xml-builder ([#276](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/276)) ([265682d](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/265682d8e16b6da87ca151ef69df1f93753a3e16))

## [2.18.1](https://github.com/mcarvin8/apex-code-coverage-transformer/compare/v2.18.0...v2.18.1) (2026-04-10)


### Bug Fixes

* **perf:** replace xmlbuilder2 with fast-xml-parser for xml formats ([#274](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/274)) ([2952623](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/2952623405d357b07504a368a20acfae562bf068))

## [2.18.0](https://github.com/mcarvin8/apex-code-coverage-transformer/compare/v2.17.0...v2.18.0) (2026-03-12)


### Features

* **html:** show source code in File Coverage Details Code column ([#272](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/272)) ([f1f4c84](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/f1f4c8444911766bb6590d4dd82fa68114d01053))


### Bug Fixes

* **deps:** bump @oclif/core from 4.8.1 to 4.8.2 ([#269](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/269)) ([a35b13a](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/a35b13a43d446d6da981d591d82b55cbd705289e))
* **deps:** bump @salesforce/core from 8.26.2 to 8.26.3 ([#270](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/270)) ([21980e7](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/21980e70430835a6589b715b230053d2f183b4d1))
...
* upgrade xmlbuilder2 from 3.1.1 to 4.0.1 ([#245](https://github.com/mcarvin8/apex-code-coverage-transformer/issues/245)) ([05bf58a](https://github.com/mcarvin8/apex-code-coverage-transformer/commit/05bf58a1ed7401b24012f96cc11a7ab3b1679f8b))
